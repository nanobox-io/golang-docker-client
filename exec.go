...
func ExecStart(containerID string, cmd []string, stdIn, stdOut, stdErr bool, user string) (dockType.ContainerExecCreateResponse, dockType.HijackedResponse, error) {
